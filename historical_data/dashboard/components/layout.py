...
def create_layout(app: Dash, data: pd.DataFrame)  -> html.Div:
    ...
    return html.Div(className='app-div',
                    children=[html.H1(app.title),
                              html.Hr(),
                              html.Div(className='fuel-dropdown-container',
                                       children=[render_fuel_dropdown(app, data)]),
                              html.Div(className='bundeslaender-dropdown-container',
                                       children=[render_bundeslaender_dropdown(app, data)]),
                              html.Div(className='year-dropdown-container',
                                       children=[render_year_dropdown(app, data)]),
